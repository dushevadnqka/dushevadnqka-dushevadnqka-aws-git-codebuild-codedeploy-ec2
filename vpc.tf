...
resource "aws_internet_gateway" "kf-ig" {
...
resource "aws_default_route_table" "public" {
  default_route_table_id = aws_vpc.kf-vpc.main_route_table_id
...
resource "aws_route" "public_internet_gateway" {
  ...
  gateway_id             = aws_internet_gateway.kf-ig.id
...
resource "aws_nat_gateway" "kf-nat" {
...
resource "aws_route" "private_nat_gateway" {
  route_table_id         = aws_route_table.private.id
  destination_cidr_block = "0.0.0.0/0"
  nat_gateway_id         = aws_nat_gateway.kf-nat.id
